...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 9b 76 10 80 	movl   $0x8010769b,(%esp)
...
80102a7b:	c7 44 24 04 c0 71 10 	movl   $0x801071c0,0x4(%esp)
80102a82:	80 
...
80102ca2:	c3                   	ret    
    panic("log.committing");
80102ca3:	c7 04 24 c4 71 10 80 	movl   $0x801071c4,(%esp)
...
80102d5d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d60:	c7 04 24 d3 71 10 80 	movl   $0x801071d3,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d6c:	c7 04 24 e9 71 10 80 	movl   $0x801071e9,(%esp)
...
80102d97:	c7 04 24 04 72 10 80 	movl   $0x80107204,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 14 28 00 00       	call   801055c0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 a5 38 00 00       	call   80106680 <switchkvm>
  seginit();
80102ddb:	e8 e0 37 00 00       	call   801065c0 <seginit>
  lapicinit();
...
80102e13:	e8 f8 3c 00 00       	call   80106b10 <kvmalloc>
...
80102e25:	e8 96 37 00 00       	call   801065c0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 a1 2a 00 00       	call   801058e0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 d6 26 00 00       	call   80105520 <tvinit>
  binit();         // buffer cache
...
80102f3f:	00 
80102f40:	c7 44 24 04 18 72 10 	movl   $0x80107218,0x4(%esp)
80102f47:	80 
...
80102ffa:	00 
80102ffb:	c7 44 24 04 1d 72 10 	movl   $0x8010721d,0x4(%esp)
80103002:	80 
...
8010308c:	ff 24 8d 5c 72 10 80 	jmp    *-0x7fef8da4(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 22 72 10 80 	movl   $0x80107222,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 3c 72 10 80 	movl   $0x8010723c,(%esp)
...
801031df:	c7 44 24 04 70 72 10 	movl   $0x80107270,0x4(%esp)
801031e6:	80 
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 1a 0e 00 00       	call   80104330 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 07 55 10 80 	movl   $0x80105507,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 2e 0e 00 00       	call   80104380 <memset>
...
801035e6:	c7 44 24 04 75 72 10 	movl   $0x80107275,0x4(%esp)
801035ed:	80 
...
8010365a:	c7 04 24 7c 72 10 80 	movl   $0x8010727c,(%esp)
...
801036e3:	e8 98 33 00 00       	call   80106a80 <setupkvm>
...
80103705:	80 
80103706:	e8 a5 30 00 00       	call   801067b0 <inituvm>
  p->sz = PGSIZE;
...
80103782:	00 
80103783:	c7 44 24 04 a5 72 10 	movl   $0x801072a5,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 cd 0d 00 00       	call   80104560 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 ae 72 10 80 	movl   $0x801072ae,(%esp)
...
801037c7:	c7 04 24 8c 72 10 80 	movl   $0x8010728c,(%esp)
...
80103809:	e8 e2 30 00 00       	call   801068f0 <allocuvm>
...
80103817:	e8 84 2e 00 00       	call   801066a0 <switchuvm>
  return 0;
...
8010383a:	e8 a1 31 00 00       	call   801069e0 <deallocuvm>
...
8010387e:	e8 dd 32 00 00       	call   80106b60 <copyuvm>
...
801039b2:	83 c3 7c             	add    $0x7c,%ebx
      switchuvm(p);
801039b5:	e8 e6 2c 00 00       	call   801066a0 <switchuvm>
...
801039cb:	e8 eb 0b 00 00       	call   801045bb <swtch>
      switchkvm();
801039d0:	e8 ab 2c 00 00       	call   80106680 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 3c 09 00 00       	call   80104330 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 65 08 00 00       	call   80104280 <holding>
...
80103a57:	e8 5f 0b 00 00       	call   801045bb <swtch>
  mycpu()->intena = intena;
...
80103a6e:	c7 04 24 b0 72 10 80 	movl   $0x801072b0,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 dc 72 10 80 	movl   $0x801072dc,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 ce 72 10 80 	movl   $0x801072ce,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 c2 72 10 80 	movl   $0x801072c2,(%esp)
...
80103b03:	e8 b8 07 00 00       	call   801042c0 <acquire>
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 fd 72 10 80 	movl   $0x801072fd,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 f0 72 10 80 	movl   $0x801072f0,(%esp)
...
80103bcd:	e8 ee 06 00 00       	call   801042c0 <acquire>
...
80103bea:	e8 41 07 00 00       	call   80104330 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 8a 06 00 00       	call   801042c0 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 f2 06 00 00       	call   80104330 <release>
  p->chan = chan;
...
80103c5b:	e8 d0 06 00 00       	call   80104330 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 51 06 00 00       	jmp    801042c0 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103c8e:	c7 04 24 0f 73 10 80 	movl   $0x8010730f,(%esp)
80103c95:	e8 c6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c9a:	c7 04 24 09 73 10 80 	movl   $0x80107309,(%esp)
...
80103cc4:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cc6:	e8 f5 05 00 00       	call   801042c0 <acquire>
    havekids = 0;
...
80103d38:	e8 c3 2c 00 00       	call   80106a00 <freevm>
        release(&ptable.lock);
...
80103d5d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103d64:	e8 c7 05 00 00       	call   80104330 <release>
}
...
80103d79:	e8 b2 05 00 00       	call   80104330 <release>
}
...
80103da1:	e8 1a 05 00 00       	call   801042c0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103de3:	5d                   	pop    %ebp
  release(&ptable.lock);
80103de4:	e9 47 05 00 00       	jmp    80104330 <release>
...
80103e01:	e8 ba 04 00 00       	call   801042c0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e33:	e8 f8 04 00 00       	call   80104330 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103e57:	e8 d4 04 00 00       	call   80104330 <release>
}
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 9b 76 10 80 	movl   $0x8010769b,(%esp)
...
80103ed0:	c7 04 24 24 73 10 80 	movl   $0x80107324,(%esp)
...
80103efc:	e8 6f 02 00 00       	call   80104170 <getcallerpcs>
...
80103f19:	c7 04 24 61 6d 10 80 	movl   $0x80106d61,(%esp)
...
80103f49:	e8 52 f7 ff ff       	call   801036a0 <myproc>
80103f4e:	89 c7                	mov    %eax,%edi
80103f50:	89 45 e4             	mov    %eax,-0x1c(%ebp)

	// Allocate process.
	if((np = allocproc()) == 0)
80103f53:	e8 68 f5 ff ff       	call   801034c0 <allocproc>
80103f58:	85 c0                	test   %eax,%eax
80103f5a:	89 c3                	mov    %eax,%ebx
80103f5c:	0f 84 b6 00 00 00    	je     80104018 <clone+0xd8>
		return -1;
		
	np->sz = proc->sz;
80103f62:	8b 07                	mov    (%edi),%eax
    np->parent = proc;
    *np->tf = *proc->tf;
80103f64:	b9 13 00 00 00       	mov    $0x13,%ecx
    np->parent = proc;
80103f69:	89 7b 14             	mov    %edi,0x14(%ebx)
    
    np->tf->esp = (uint)(stack + size -4); //put esp to right spot on stack
80103f6c:	8b 55 0c             	mov    0xc(%ebp),%edx
	np->sz = proc->sz;
80103f6f:	89 03                	mov    %eax,(%ebx)
    *np->tf = *proc->tf;
80103f71:	8b 77 18             	mov    0x18(%edi),%esi
80103f74:	8b 7b 18             	mov    0x18(%ebx),%edi
80103f77:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    np->tf->esp = (uint)(stack + size -4); //put esp to right spot on stack
80103f79:	8b 4d 08             	mov    0x8(%ebp),%ecx
    *((uint*)(np->tf->esp)) = 0xFFFFFFFF;
    ...
    for(i = 0; i < NOFILE; i++)
80103f7c:	31 f6                	xor    %esi,%esi
    np->tf->esp = (uint)(stack + size -4); //put esp to right spot on stack
80103f7e:	8b 43 18             	mov    0x18(%ebx),%eax
80103f81:	8d 54 11 fc          	lea    -0x4(%ecx,%edx,1),%edx
80103f85:	89 50 44             	mov    %edx,0x44(%eax)
    *((uint*)(np->tf->esp)) = 0xFFFFFFFF;
80103f88:	8b 43 18             	mov    0x18(%ebx),%eax
80103f8b:	8b 40 44             	mov    0x44(%eax),%eax
80103f8e:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
    np->tf->eax = 0;
80103f94:	8b 43 18             	mov    0x18(%ebx),%eax
80103f97:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
80103f9e:	66 90                	xchg   %ax,%ax
      if(proc->ofile[i])
80103fa0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103fa3:	8b 44 b0 28          	mov    0x28(%eax,%esi,4),%eax
80103fa7:	85 c0                	test   %eax,%eax
80103fa9:	74 0c                	je     80103fb7 <clone+0x77>
        np->ofile[i] = filedup(proc->ofile[i]);
80103fab:	89 04 24             	mov    %eax,(%esp)
80103fae:	e8 2d ce ff ff       	call   80100de0 <filedup>
80103fb3:	89 44 b3 28          	mov    %eax,0x28(%ebx,%esi,4)
    for(i = 0; i < NOFILE; i++)
80103fb7:	83 c6 01             	add    $0x1,%esi
80103fba:	83 fe 10             	cmp    $0x10,%esi
80103fbd:	75 e1                	jne    80103fa0 <clone+0x60>
	np->cwd = idup(proc->cwd);
80103fbf:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103fc2:	8b 47 68             	mov    0x68(%edi),%eax
80103fc5:	89 04 24             	mov    %eax,(%esp)
80103fc8:	e8 b3 d6 ff ff       	call   80101680 <idup>
80103fcd:	89 43 68             	mov    %eax,0x68(%ebx)

    safestrcpy(np->name, proc->name, sizeof(proc->name));
80103fd0:	89 f8                	mov    %edi,%eax
80103fd2:	83 c0 6c             	add    $0x6c,%eax
80103fd5:	89 44 24 04          	mov    %eax,0x4(%esp)
80103fd9:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103fdc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103fe3:	00 
80103fe4:	89 04 24             	mov    %eax,(%esp)
80103fe7:	e8 74 05 00 00       	call   80104560 <safestrcpy>

    pid = np->pid;
80103fec:	8b 73 10             	mov    0x10(%ebx),%esi

    acquire(&ptable.lock);
80103fef:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ff6:	e8 c5 02 00 00       	call   801042c0 <acquire>

    np->state = RUNNABLE;
80103ffb:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)

    release(&ptable.lock);
80104002:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104009:	e8 22 03 00 00       	call   80104330 <release>
	
	
	return pid;
8010400e:	89 f0                	mov    %esi,%eax
}
80104010:	83 c4 1c             	add    $0x1c,%esp
80104013:	5b                   	pop    %ebx
80104014:	5e                   	pop    %esi
80104015:	5f                   	pop    %edi
80104016:	5d                   	pop    %ebp
...
8010401d:	eb f1                	jmp    80104010 <clone+0xd0>
8010401f:	90                   	nop
...
8010402a:	c7 44 24 04 98 73 10 	movl   $0x80107398,0x4(%esp)
80104031:	80 
...
80104087:	e8 74 fb ff ff       	call   80103c00 <sleep>
  while (lk->locked) {
...
801040e6:	e8 a5 fc ff ff       	call   80103d90 <wakeup>
  release(&lk->lk);
...
80104259:	c3                   	ret    
    panic("popcli");
8010425a:	c7 04 24 ba 73 10 80 	movl   $0x801073ba,(%esp)
80104261:	e8 fa c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104266:	c7 04 24 a3 73 10 80 	movl   $0x801073a3,(%esp)
...
801042d9:	75 3a                	jne    80104315 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
...
801042ea:	75 f4                	jne    801042e0 <acquire+0x20>
  __sync_synchronize();
801042ec:	0f ae f0             	mfence 
  lk->cpu = mycpu();
801042ef:	8b 5d 08             	mov    0x8(%ebp),%ebx
801042f2:	e8 09 f3 ff ff       	call   80103600 <mycpu>
801042f7:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801042fa:	8b 45 08             	mov    0x8(%ebp),%eax
801042fd:	83 c0 0c             	add    $0xc,%eax
80104300:	89 44 24 04          	mov    %eax,0x4(%esp)
80104304:	8d 45 08             	lea    0x8(%ebp),%eax
80104307:	89 04 24             	mov    %eax,(%esp)
8010430a:	e8 61 fe ff ff       	call   80104170 <getcallerpcs>
}
...
80104314:	c3                   	ret    
    panic("acquire");
80104315:	c7 04 24 c1 73 10 80 	movl   $0x801073c1,(%esp)
8010431c:	e8 3f c0 ff ff       	call   80100360 <panic>
80104321:	eb 0d                	jmp    80104330 <release>
80104323:	90                   	nop
80104324:	90                   	nop
80104325:	90                   	nop
80104326:	90                   	nop
...
80104344:	74 21                	je     80104367 <release+0x37>
  lk->pcs[0] = 0;
80104346:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
8010434d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104354:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104357:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010435d:	83 c4 14             	add    $0x14,%esp
80104360:	5b                   	pop    %ebx
80104361:	5d                   	pop    %ebp
  popcli();
80104362:	e9 a9 fe ff ff       	jmp    80104210 <popcli>
    panic("release");
80104367:	c7 04 24 c9 73 10 80 	movl   $0x801073c9,(%esp)
...
80104745:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104748:	e8 53 ef ff ff       	call   801036a0 <myproc>
...
80104758:	83 fa 15             	cmp    $0x15,%edx
8010475b:	77 1b                	ja     80104778 <syscall+0x38>
8010475d:	8b 14 85 00 74 10 80 	mov    -0x7fef8c00(,%eax,4),%edx
...
80104786:	c7 04 24 d1 73 10 80 	movl   $0x801073d1,(%esp)
...
80104910:	c7 44 24 04 78 74 10 	movl   $0x80107478,0x4(%esp)
80104917:	80 
...
8010492b:	c7 44 24 04 77 74 10 	movl   $0x80107477,0x4(%esp)
80104932:	80 
...
80104941:	79 89                	jns    801048cc <create+0xdc>
      panic("create dots");
80104943:	c7 04 24 6b 74 10 80 	movl   $0x8010746b,(%esp)
8010494a:	e8 11 ba ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010494f:	c7 04 24 7a 74 10 80 	movl   $0x8010747a,(%esp)
80104956:	e8 05 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010495b:	c7 04 24 5c 74 10 80 	movl   $0x8010745c,(%esp)
...
80104d01:	c7 44 24 04 78 74 10 	movl   $0x80107478,0x4(%esp)
80104d08:	80 
...
80104d19:	c7 44 24 04 77 74 10 	movl   $0x80107477,0x4(%esp)
80104d20:	80 
...
80104e6d:	c7 04 24 9c 74 10 80 	movl   $0x8010749c,(%esp)
80104e74:	e8 e7 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104e79:	c7 04 24 ae 74 10 80 	movl   $0x801074ae,(%esp)
80104e80:	e8 db b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104e85:	c7 04 24 8a 74 10 80 	movl   $0x8010748a,(%esp)
...
80105303:	83 ec 08             	sub    $0x8,%esp
  exit();
80105306:	e8 95 e7 ff ff       	call   80103aa0 <exit>
...
80105313:	5d                   	pop    %ebp
  return wait();
80105314:	e9 97 e9 ff ff       	jmp    80103cb0 <wait>
...
80105343:	e8 a8 ea ff ff       	call   80103df0 <kill>
}
80105348:	c9                   	leave  
80105349:	c3                   	ret    
...
801053dc:	78 7e                	js     8010545c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801053de:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801053e5:	e8 d6 ee ff ff       	call   801042c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801053ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801053ed:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105400:	c7 44 24 04 60 4c 11 	movl   $0x80114c60,0x4(%esp)
80105407:	80 
80105408:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
8010540f:	e8 ec e7 ff ff       	call   80103c00 <sleep>
  while(ticks - ticks0 < n){
80105414:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010542a:	74 d4                	je     80105400 <sys_sleep+0x40>
      release(&tickslock);
8010542c:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105444:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105448:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105474:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105477:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
8010547e:	e8 3d ee ff ff       	call   801042c0 <acquire>
  xticks = ticks;
80105483:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
80105489:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
801054b4:	e8 b7 f1 ff ff       	call   80104670 <argint>
801054b9:	85 c0                	test   %eax,%eax
801054bb:	78 2b                	js     801054e8 <sys_clone+0x48>
		return -1;
		
	if(argint(1, &size) < 0)
801054bd:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801054c4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054cb:	e8 a0 f1 ff ff       	call   80104670 <argint>
801054d0:	85 c0                	test   %eax,%eax
801054d2:	78 14                	js     801054e8 <sys_clone+0x48>
		return -1;
...
801054e1:	e8 5a ea ff ff       	call   80103f40 <clone>
}
801054e6:	c9                   	leave  
801054e7:	c3                   	ret    
		return -1;
...
801054f0:	06                   	push   %es
  pushl %fs
801054f1:	0f a0                	push   %fs
  pushl %gs
801054f3:	0f a8                	push   %gs
  pushal
801054f5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801054f6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801054fa:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801054fc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801054fe:	54                   	push   %esp
  call trap
801054ff:	e8 ec 00 00 00       	call   801055f0 <trap>
  addl $4, %esp
80105504:	83 c4 04             	add    $0x4,%esp
...
80105507:	61                   	popa   
  popl %gs
80105508:	0f a9                	pop    %gs
  popl %fs
8010550a:	0f a1                	pop    %fs
  popl %es
8010550c:	07                   	pop    %es
  popl %ds
8010550d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010550e:	83 c4 08             	add    $0x8,%esp
  iret
80105511:	cf                   	iret   
80105512:	66 90                	xchg   %ax,%ax
...
80105534:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
8010553b:	80 
8010553c:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
80105543:	00 
80105544:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010554b:	8e 
8010554c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105553:	80 
80105554:	c1 ea 10             	shr    $0x10,%edx
80105557:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010555e:	80 
  for(i = 0; i < 256; i++)
...
80105579:	c7 44 24 04 bd 74 10 	movl   $0x801074bd,0x4(%esp)
80105580:	80 
80105581:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105588:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010558f:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105595:	c1 e8 10             	shr    $0x10,%eax
80105598:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
8010559f:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801055a6:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801055ac:	e8 9f eb ff ff       	call   80104150 <initlock>
}
801055b1:	c9                   	leave  
801055b2:	c3                   	ret    
...
801055cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801055cf:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80105610:	ff 24 85 64 75 10 80 	jmp    *-0x7fef8a9c(,%eax,4)
80105617:	90                   	nop
    lapiceoi();
    break;
...
8010563c:	e8 3f e0 ff ff       	call   80103680 <cpuid>
...
8010564c:	e8 4f e0 ff ff       	call   801036a0 <myproc>
80105651:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105654:	e8 47 e0 ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105683:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
...
801056b5:	e8 e6 df ff ff       	call   801036a0 <myproc>
...
801056c9:	74 4d                	je     80105718 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801056cb:	e8 d0 df ff ff       	call   801036a0 <myproc>
...
8010570b:	75 a8                	jne    801056b5 <trap+0xc5>
    exit();
8010570d:	e8 8e e3 ff ff       	call   80103aa0 <exit>
...
80105777:	e8 04 df ff ff       	call   80103680 <cpuid>
8010577c:	c7 04 24 c8 74 10 80 	movl   $0x801074c8,(%esp)
...
801057df:	5d                   	pop    %ebp
      exit();
801057e0:	e9 bb e2 ff ff       	jmp    80103aa0 <exit>
...
801057ef:	90                   	nop
      acquire(&tickslock);
801057f0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801057f7:	e8 c4 ea ff ff       	call   801042c0 <acquire>
      wakeup(&ticks);
801057fc:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105803:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010580a:	e8 81 e5 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010580f:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105816:	e8 15 eb ff ff       	call   80104330 <release>
8010581b:	e9 1d ff ff ff       	jmp    8010573d <trap+0x14d>
80105820:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105823:	8b 73 38             	mov    0x38(%ebx),%esi
80105826:	e8 55 de ff ff       	call   80103680 <cpuid>
...
8010583a:	c7 04 24 ec 74 10 80 	movl   $0x801074ec,(%esp)
80105841:	89 44 24 04          	mov    %eax,0x4(%esp)
80105845:	e8 06 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010584a:	c7 04 24 c2 74 10 80 	movl   $0x801074c2,(%esp)
...
801058b7:	e8 e4 ce ff ff       	call   801027a0 <microdelay>
...
80105947:	00 
  for(p="xv6...\n"; *p; p++)
80105948:	bb e4 75 10 80       	mov    $0x801075e4,%ebx
  ioapicenable(IRQ_COM1, 0);
8010594d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105954:	e8 57 c9 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105996:	6a 00                	push   $0x0
  jmp alltraps
80105998:	e9 52 fb ff ff       	jmp    801054ef <alltraps>
...
8010599f:	6a 01                	push   $0x1
  jmp alltraps
801059a1:	e9 49 fb ff ff       	jmp    801054ef <alltraps>
...
801059a8:	6a 02                	push   $0x2
  jmp alltraps
801059aa:	e9 40 fb ff ff       	jmp    801054ef <alltraps>
...
801059b1:	6a 03                	push   $0x3
  jmp alltraps
801059b3:	e9 37 fb ff ff       	jmp    801054ef <alltraps>
...
801059ba:	6a 04                	push   $0x4
  jmp alltraps
801059bc:	e9 2e fb ff ff       	jmp    801054ef <alltraps>
...
801059c3:	6a 05                	push   $0x5
  jmp alltraps
801059c5:	e9 25 fb ff ff       	jmp    801054ef <alltraps>
...
801059cc:	6a 06                	push   $0x6
  jmp alltraps
801059ce:	e9 1c fb ff ff       	jmp    801054ef <alltraps>
...
801059d5:	6a 07                	push   $0x7
  jmp alltraps
801059d7:	e9 13 fb ff ff       	jmp    801054ef <alltraps>
...
801059dc:	6a 08                	push   $0x8
  jmp alltraps
801059de:	e9 0c fb ff ff       	jmp    801054ef <alltraps>
...
801059e5:	6a 09                	push   $0x9
  jmp alltraps
801059e7:	e9 03 fb ff ff       	jmp    801054ef <alltraps>
...
801059ec:	6a 0a                	push   $0xa
  jmp alltraps
801059ee:	e9 fc fa ff ff       	jmp    801054ef <alltraps>
...
801059f3:	6a 0b                	push   $0xb
  jmp alltraps
801059f5:	e9 f5 fa ff ff       	jmp    801054ef <alltraps>
...
801059fa:	6a 0c                	push   $0xc
  jmp alltraps
801059fc:	e9 ee fa ff ff       	jmp    801054ef <alltraps>
...
80105a01:	6a 0d                	push   $0xd
  jmp alltraps
80105a03:	e9 e7 fa ff ff       	jmp    801054ef <alltraps>
...
80105a08:	6a 0e                	push   $0xe
  jmp alltraps
80105a0a:	e9 e0 fa ff ff       	jmp    801054ef <alltraps>
...
80105a11:	6a 0f                	push   $0xf
  jmp alltraps
80105a13:	e9 d7 fa ff ff       	jmp    801054ef <alltraps>
...
80105a1a:	6a 10                	push   $0x10
  jmp alltraps
80105a1c:	e9 ce fa ff ff       	jmp    801054ef <alltraps>
...
80105a21:	6a 11                	push   $0x11
  jmp alltraps
80105a23:	e9 c7 fa ff ff       	jmp    801054ef <alltraps>
...
80105a2a:	6a 12                	push   $0x12
  jmp alltraps
80105a2c:	e9 be fa ff ff       	jmp    801054ef <alltraps>
...
80105a33:	6a 13                	push   $0x13
  jmp alltraps
80105a35:	e9 b5 fa ff ff       	jmp    801054ef <alltraps>
...
80105a3c:	6a 14                	push   $0x14
  jmp alltraps
80105a3e:	e9 ac fa ff ff       	jmp    801054ef <alltraps>
...
80105a45:	6a 15                	push   $0x15
  jmp alltraps
80105a47:	e9 a3 fa ff ff       	jmp    801054ef <alltraps>
...
80105a4e:	6a 16                	push   $0x16
  jmp alltraps
80105a50:	e9 9a fa ff ff       	jmp    801054ef <alltraps>
...
80105a57:	6a 17                	push   $0x17
  jmp alltraps
80105a59:	e9 91 fa ff ff       	jmp    801054ef <alltraps>
...
80105a60:	6a 18                	push   $0x18
  jmp alltraps
80105a62:	e9 88 fa ff ff       	jmp    801054ef <alltraps>
...
80105a69:	6a 19                	push   $0x19
  jmp alltraps
80105a6b:	e9 7f fa ff ff       	jmp    801054ef <alltraps>
...
80105a72:	6a 1a                	push   $0x1a
  jmp alltraps
80105a74:	e9 76 fa ff ff       	jmp    801054ef <alltraps>
...
80105a7b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a7d:	e9 6d fa ff ff       	jmp    801054ef <alltraps>
...
80105a84:	6a 1c                	push   $0x1c
  jmp alltraps
80105a86:	e9 64 fa ff ff       	jmp    801054ef <alltraps>
...
80105a8d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a8f:	e9 5b fa ff ff       	jmp    801054ef <alltraps>
...
80105a96:	6a 1e                	push   $0x1e
  jmp alltraps
80105a98:	e9 52 fa ff ff       	jmp    801054ef <alltraps>
...
80105a9f:	6a 1f                	push   $0x1f
  jmp alltraps
80105aa1:	e9 49 fa ff ff       	jmp    801054ef <alltraps>
...
80105aa8:	6a 20                	push   $0x20
  jmp alltraps
80105aaa:	e9 40 fa ff ff       	jmp    801054ef <alltraps>
...
80105ab1:	6a 21                	push   $0x21
  jmp alltraps
80105ab3:	e9 37 fa ff ff       	jmp    801054ef <alltraps>
...
80105aba:	6a 22                	push   $0x22
  jmp alltraps
80105abc:	e9 2e fa ff ff       	jmp    801054ef <alltraps>
...
80105ac3:	6a 23                	push   $0x23
  jmp alltraps
80105ac5:	e9 25 fa ff ff       	jmp    801054ef <alltraps>
...
80105acc:	6a 24                	push   $0x24
  jmp alltraps
80105ace:	e9 1c fa ff ff       	jmp    801054ef <alltraps>
...
80105ad5:	6a 25                	push   $0x25
  jmp alltraps
80105ad7:	e9 13 fa ff ff       	jmp    801054ef <alltraps>
...
80105ade:	6a 26                	push   $0x26
  jmp alltraps
80105ae0:	e9 0a fa ff ff       	jmp    801054ef <alltraps>
...
80105ae7:	6a 27                	push   $0x27
  jmp alltraps
80105ae9:	e9 01 fa ff ff       	jmp    801054ef <alltraps>
...
80105af0:	6a 28                	push   $0x28
  jmp alltraps
80105af2:	e9 f8 f9 ff ff       	jmp    801054ef <alltraps>
...
80105af9:	6a 29                	push   $0x29
  jmp alltraps
80105afb:	e9 ef f9 ff ff       	jmp    801054ef <alltraps>
...
80105b02:	6a 2a                	push   $0x2a
  jmp alltraps
80105b04:	e9 e6 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b0b:	6a 2b                	push   $0x2b
  jmp alltraps
80105b0d:	e9 dd f9 ff ff       	jmp    801054ef <alltraps>
...
80105b14:	6a 2c                	push   $0x2c
  jmp alltraps
80105b16:	e9 d4 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b1d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b1f:	e9 cb f9 ff ff       	jmp    801054ef <alltraps>
...
80105b26:	6a 2e                	push   $0x2e
  jmp alltraps
80105b28:	e9 c2 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b2f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b31:	e9 b9 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b38:	6a 30                	push   $0x30
  jmp alltraps
80105b3a:	e9 b0 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b41:	6a 31                	push   $0x31
  jmp alltraps
80105b43:	e9 a7 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b4a:	6a 32                	push   $0x32
  jmp alltraps
80105b4c:	e9 9e f9 ff ff       	jmp    801054ef <alltraps>
...
80105b53:	6a 33                	push   $0x33
  jmp alltraps
80105b55:	e9 95 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b5c:	6a 34                	push   $0x34
  jmp alltraps
80105b5e:	e9 8c f9 ff ff       	jmp    801054ef <alltraps>
...
80105b65:	6a 35                	push   $0x35
  jmp alltraps
80105b67:	e9 83 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b6e:	6a 36                	push   $0x36
  jmp alltraps
80105b70:	e9 7a f9 ff ff       	jmp    801054ef <alltraps>
...
80105b77:	6a 37                	push   $0x37
  jmp alltraps
80105b79:	e9 71 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b80:	6a 38                	push   $0x38
  jmp alltraps
80105b82:	e9 68 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b89:	6a 39                	push   $0x39
  jmp alltraps
80105b8b:	e9 5f f9 ff ff       	jmp    801054ef <alltraps>
...
80105b92:	6a 3a                	push   $0x3a
  jmp alltraps
80105b94:	e9 56 f9 ff ff       	jmp    801054ef <alltraps>
...
80105b9b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b9d:	e9 4d f9 ff ff       	jmp    801054ef <alltraps>
...
80105ba4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ba6:	e9 44 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bad:	6a 3d                	push   $0x3d
  jmp alltraps
80105baf:	e9 3b f9 ff ff       	jmp    801054ef <alltraps>
...
80105bb6:	6a 3e                	push   $0x3e
  jmp alltraps
80105bb8:	e9 32 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bbf:	6a 3f                	push   $0x3f
  jmp alltraps
80105bc1:	e9 29 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bc8:	6a 40                	push   $0x40
  jmp alltraps
80105bca:	e9 20 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bd1:	6a 41                	push   $0x41
  jmp alltraps
80105bd3:	e9 17 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bda:	6a 42                	push   $0x42
  jmp alltraps
80105bdc:	e9 0e f9 ff ff       	jmp    801054ef <alltraps>
...
80105be3:	6a 43                	push   $0x43
  jmp alltraps
80105be5:	e9 05 f9 ff ff       	jmp    801054ef <alltraps>
...
80105bec:	6a 44                	push   $0x44
  jmp alltraps
80105bee:	e9 fc f8 ff ff       	jmp    801054ef <alltraps>
...
80105bf5:	6a 45                	push   $0x45
  jmp alltraps
80105bf7:	e9 f3 f8 ff ff       	jmp    801054ef <alltraps>
...
80105bfe:	6a 46                	push   $0x46
  jmp alltraps
80105c00:	e9 ea f8 ff ff       	jmp    801054ef <alltraps>
...
80105c07:	6a 47                	push   $0x47
  jmp alltraps
80105c09:	e9 e1 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c10:	6a 48                	push   $0x48
  jmp alltraps
80105c12:	e9 d8 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c19:	6a 49                	push   $0x49
  jmp alltraps
80105c1b:	e9 cf f8 ff ff       	jmp    801054ef <alltraps>
...
80105c22:	6a 4a                	push   $0x4a
  jmp alltraps
80105c24:	e9 c6 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c2b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c2d:	e9 bd f8 ff ff       	jmp    801054ef <alltraps>
...
80105c34:	6a 4c                	push   $0x4c
  jmp alltraps
80105c36:	e9 b4 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c3d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c3f:	e9 ab f8 ff ff       	jmp    801054ef <alltraps>
...
80105c46:	6a 4e                	push   $0x4e
  jmp alltraps
80105c48:	e9 a2 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c4f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c51:	e9 99 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c58:	6a 50                	push   $0x50
  jmp alltraps
80105c5a:	e9 90 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c61:	6a 51                	push   $0x51
  jmp alltraps
80105c63:	e9 87 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c6a:	6a 52                	push   $0x52
  jmp alltraps
80105c6c:	e9 7e f8 ff ff       	jmp    801054ef <alltraps>
...
80105c73:	6a 53                	push   $0x53
  jmp alltraps
80105c75:	e9 75 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c7c:	6a 54                	push   $0x54
  jmp alltraps
80105c7e:	e9 6c f8 ff ff       	jmp    801054ef <alltraps>
...
80105c85:	6a 55                	push   $0x55
  jmp alltraps
80105c87:	e9 63 f8 ff ff       	jmp    801054ef <alltraps>
...
80105c8e:	6a 56                	push   $0x56
  jmp alltraps
80105c90:	e9 5a f8 ff ff       	jmp    801054ef <alltraps>
...
80105c97:	6a 57                	push   $0x57
  jmp alltraps
80105c99:	e9 51 f8 ff ff       	jmp    801054ef <alltraps>
...
80105ca0:	6a 58                	push   $0x58
  jmp alltraps
80105ca2:	e9 48 f8 ff ff       	jmp    801054ef <alltraps>
...
80105ca9:	6a 59                	push   $0x59
  jmp alltraps
80105cab:	e9 3f f8 ff ff       	jmp    801054ef <alltraps>
...
80105cb2:	6a 5a                	push   $0x5a
  jmp alltraps
80105cb4:	e9 36 f8 ff ff       	jmp    801054ef <alltraps>
...
80105cbb:	6a 5b                	push   $0x5b
  jmp alltraps
80105cbd:	e9 2d f8 ff ff       	jmp    801054ef <alltraps>
...
80105cc4:	6a 5c                	push   $0x5c
  jmp alltraps
80105cc6:	e9 24 f8 ff ff       	jmp    801054ef <alltraps>
...
80105ccd:	6a 5d                	push   $0x5d
  jmp alltraps
80105ccf:	e9 1b f8 ff ff       	jmp    801054ef <alltraps>
...
80105cd6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cd8:	e9 12 f8 ff ff       	jmp    801054ef <alltraps>
...
80105cdf:	6a 5f                	push   $0x5f
  jmp alltraps
80105ce1:	e9 09 f8 ff ff       	jmp    801054ef <alltraps>
...
80105ce8:	6a 60                	push   $0x60
  jmp alltraps
80105cea:	e9 00 f8 ff ff       	jmp    801054ef <alltraps>
...
80105cf1:	6a 61                	push   $0x61
  jmp alltraps
80105cf3:	e9 f7 f7 ff ff       	jmp    801054ef <alltraps>
...
80105cfa:	6a 62                	push   $0x62
  jmp alltraps
80105cfc:	e9 ee f7 ff ff       	jmp    801054ef <alltraps>
...
80105d03:	6a 63                	push   $0x63
  jmp alltraps
80105d05:	e9 e5 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d0c:	6a 64                	push   $0x64
  jmp alltraps
80105d0e:	e9 dc f7 ff ff       	jmp    801054ef <alltraps>
...
80105d15:	6a 65                	push   $0x65
  jmp alltraps
80105d17:	e9 d3 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d1e:	6a 66                	push   $0x66
  jmp alltraps
80105d20:	e9 ca f7 ff ff       	jmp    801054ef <alltraps>
...
80105d27:	6a 67                	push   $0x67
  jmp alltraps
80105d29:	e9 c1 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d30:	6a 68                	push   $0x68
  jmp alltraps
80105d32:	e9 b8 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d39:	6a 69                	push   $0x69
  jmp alltraps
80105d3b:	e9 af f7 ff ff       	jmp    801054ef <alltraps>
...
80105d42:	6a 6a                	push   $0x6a
  jmp alltraps
80105d44:	e9 a6 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d4b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d4d:	e9 9d f7 ff ff       	jmp    801054ef <alltraps>
...
80105d54:	6a 6c                	push   $0x6c
  jmp alltraps
80105d56:	e9 94 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d5d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d5f:	e9 8b f7 ff ff       	jmp    801054ef <alltraps>
...
80105d66:	6a 6e                	push   $0x6e
  jmp alltraps
80105d68:	e9 82 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d6f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d71:	e9 79 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d78:	6a 70                	push   $0x70
  jmp alltraps
80105d7a:	e9 70 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d81:	6a 71                	push   $0x71
  jmp alltraps
80105d83:	e9 67 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d8a:	6a 72                	push   $0x72
  jmp alltraps
80105d8c:	e9 5e f7 ff ff       	jmp    801054ef <alltraps>
...
80105d93:	6a 73                	push   $0x73
  jmp alltraps
80105d95:	e9 55 f7 ff ff       	jmp    801054ef <alltraps>
...
80105d9c:	6a 74                	push   $0x74
  jmp alltraps
80105d9e:	e9 4c f7 ff ff       	jmp    801054ef <alltraps>
...
80105da5:	6a 75                	push   $0x75
  jmp alltraps
80105da7:	e9 43 f7 ff ff       	jmp    801054ef <alltraps>
...
80105dae:	6a 76                	push   $0x76
  jmp alltraps
80105db0:	e9 3a f7 ff ff       	jmp    801054ef <alltraps>
...
80105db7:	6a 77                	push   $0x77
  jmp alltraps
80105db9:	e9 31 f7 ff ff       	jmp    801054ef <alltraps>
...
80105dc0:	6a 78                	push   $0x78
  jmp alltraps
80105dc2:	e9 28 f7 ff ff       	jmp    801054ef <alltraps>
...
80105dc9:	6a 79                	push   $0x79
  jmp alltraps
80105dcb:	e9 1f f7 ff ff       	jmp    801054ef <alltraps>
...
80105dd2:	6a 7a                	push   $0x7a
  jmp alltraps
80105dd4:	e9 16 f7 ff ff       	jmp    801054ef <alltraps>
...
80105ddb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ddd:	e9 0d f7 ff ff       	jmp    801054ef <alltraps>
...
80105de4:	6a 7c                	push   $0x7c
  jmp alltraps
80105de6:	e9 04 f7 ff ff       	jmp    801054ef <alltraps>
...
80105ded:	6a 7d                	push   $0x7d
  jmp alltraps
80105def:	e9 fb f6 ff ff       	jmp    801054ef <alltraps>
...
80105df6:	6a 7e                	push   $0x7e
  jmp alltraps
80105df8:	e9 f2 f6 ff ff       	jmp    801054ef <alltraps>
...
80105dff:	6a 7f                	push   $0x7f
  jmp alltraps
80105e01:	e9 e9 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e08:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105e0d:	e9 dd f6 ff ff       	jmp    801054ef <alltraps>
...
80105e14:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105e19:	e9 d1 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e20:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e25:	e9 c5 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e2c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e31:	e9 b9 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e38:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e3d:	e9 ad f6 ff ff       	jmp    801054ef <alltraps>
...
80105e44:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e49:	e9 a1 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e50:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e55:	e9 95 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e5c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e61:	e9 89 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e68:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e6d:	e9 7d f6 ff ff       	jmp    801054ef <alltraps>
...
80105e74:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e79:	e9 71 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e80:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e85:	e9 65 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e8c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e91:	e9 59 f6 ff ff       	jmp    801054ef <alltraps>
...
80105e98:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e9d:	e9 4d f6 ff ff       	jmp    801054ef <alltraps>
...
80105ea4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105ea9:	e9 41 f6 ff ff       	jmp    801054ef <alltraps>
...
80105eb0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105eb5:	e9 35 f6 ff ff       	jmp    801054ef <alltraps>
...
80105ebc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ec1:	e9 29 f6 ff ff       	jmp    801054ef <alltraps>
...
80105ec8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ecd:	e9 1d f6 ff ff       	jmp    801054ef <alltraps>
...
80105ed4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105ed9:	e9 11 f6 ff ff       	jmp    801054ef <alltraps>
...
80105ee0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ee5:	e9 05 f6 ff ff       	jmp    801054ef <alltraps>
...
80105eec:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105ef1:	e9 f9 f5 ff ff       	jmp    801054ef <alltraps>
...
80105ef8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105efd:	e9 ed f5 ff ff       	jmp    801054ef <alltraps>
...
80105f04:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105f09:	e9 e1 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f10:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105f15:	e9 d5 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f1c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f21:	e9 c9 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f28:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f2d:	e9 bd f5 ff ff       	jmp    801054ef <alltraps>
...
80105f34:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f39:	e9 b1 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f40:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f45:	e9 a5 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f4c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f51:	e9 99 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f58:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f5d:	e9 8d f5 ff ff       	jmp    801054ef <alltraps>
...
80105f64:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f69:	e9 81 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f70:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f75:	e9 75 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f7c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f81:	e9 69 f5 ff ff       	jmp    801054ef <alltraps>
...
80105f88:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f8d:	e9 5d f5 ff ff       	jmp    801054ef <alltraps>
...
80105f94:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f99:	e9 51 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fa0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105fa5:	e9 45 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fac:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105fb1:	e9 39 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fb8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105fbd:	e9 2d f5 ff ff       	jmp    801054ef <alltraps>
...
80105fc4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fc9:	e9 21 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fd0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fd5:	e9 15 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fdc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105fe1:	e9 09 f5 ff ff       	jmp    801054ef <alltraps>
...
80105fe8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105fed:	e9 fd f4 ff ff       	jmp    801054ef <alltraps>
...
80105ff4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105ff9:	e9 f1 f4 ff ff       	jmp    801054ef <alltraps>
...
80106000:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106005:	e9 e5 f4 ff ff       	jmp    801054ef <alltraps>
...
8010600c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106011:	e9 d9 f4 ff ff       	jmp    801054ef <alltraps>
...
80106018:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010601d:	e9 cd f4 ff ff       	jmp    801054ef <alltraps>
...
80106024:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106029:	e9 c1 f4 ff ff       	jmp    801054ef <alltraps>
...
80106030:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106035:	e9 b5 f4 ff ff       	jmp    801054ef <alltraps>
...
8010603c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106041:	e9 a9 f4 ff ff       	jmp    801054ef <alltraps>
...
80106048:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010604d:	e9 9d f4 ff ff       	jmp    801054ef <alltraps>
...
80106054:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106059:	e9 91 f4 ff ff       	jmp    801054ef <alltraps>
...
80106060:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106065:	e9 85 f4 ff ff       	jmp    801054ef <alltraps>
...
8010606c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106071:	e9 79 f4 ff ff       	jmp    801054ef <alltraps>
...
80106078:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010607d:	e9 6d f4 ff ff       	jmp    801054ef <alltraps>
...
80106084:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106089:	e9 61 f4 ff ff       	jmp    801054ef <alltraps>
...
80106090:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106095:	e9 55 f4 ff ff       	jmp    801054ef <alltraps>
...
8010609c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801060a1:	e9 49 f4 ff ff       	jmp    801054ef <alltraps>
...
801060a8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801060ad:	e9 3d f4 ff ff       	jmp    801054ef <alltraps>
...
801060b4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801060b9:	e9 31 f4 ff ff       	jmp    801054ef <alltraps>
...
801060c0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060c5:	e9 25 f4 ff ff       	jmp    801054ef <alltraps>
...
801060cc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060d1:	e9 19 f4 ff ff       	jmp    801054ef <alltraps>
...
801060d8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060dd:	e9 0d f4 ff ff       	jmp    801054ef <alltraps>
...
801060e4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060e9:	e9 01 f4 ff ff       	jmp    801054ef <alltraps>
...
801060f0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801060f5:	e9 f5 f3 ff ff       	jmp    801054ef <alltraps>
...
801060fc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106101:	e9 e9 f3 ff ff       	jmp    801054ef <alltraps>
...
80106108:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010610d:	e9 dd f3 ff ff       	jmp    801054ef <alltraps>
...
80106114:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106119:	e9 d1 f3 ff ff       	jmp    801054ef <alltraps>
...
80106120:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106125:	e9 c5 f3 ff ff       	jmp    801054ef <alltraps>
...
8010612c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106131:	e9 b9 f3 ff ff       	jmp    801054ef <alltraps>
...
80106138:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010613d:	e9 ad f3 ff ff       	jmp    801054ef <alltraps>
...
80106144:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106149:	e9 a1 f3 ff ff       	jmp    801054ef <alltraps>
...
80106150:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106155:	e9 95 f3 ff ff       	jmp    801054ef <alltraps>
...
8010615c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106161:	e9 89 f3 ff ff       	jmp    801054ef <alltraps>
...
80106168:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010616d:	e9 7d f3 ff ff       	jmp    801054ef <alltraps>
...
80106174:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106179:	e9 71 f3 ff ff       	jmp    801054ef <alltraps>
...
80106180:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106185:	e9 65 f3 ff ff       	jmp    801054ef <alltraps>
...
8010618c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106191:	e9 59 f3 ff ff       	jmp    801054ef <alltraps>
...
80106198:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010619d:	e9 4d f3 ff ff       	jmp    801054ef <alltraps>
...
801061a4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801061a9:	e9 41 f3 ff ff       	jmp    801054ef <alltraps>
...
801061b0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801061b5:	e9 35 f3 ff ff       	jmp    801054ef <alltraps>
...
801061bc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061c1:	e9 29 f3 ff ff       	jmp    801054ef <alltraps>
...
801061c8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061cd:	e9 1d f3 ff ff       	jmp    801054ef <alltraps>
...
801061d4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061d9:	e9 11 f3 ff ff       	jmp    801054ef <alltraps>
...
801061e0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061e5:	e9 05 f3 ff ff       	jmp    801054ef <alltraps>
...
801061ec:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801061f1:	e9 f9 f2 ff ff       	jmp    801054ef <alltraps>
...
801061f8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801061fd:	e9 ed f2 ff ff       	jmp    801054ef <alltraps>
...
80106204:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106209:	e9 e1 f2 ff ff       	jmp    801054ef <alltraps>
...
80106210:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106215:	e9 d5 f2 ff ff       	jmp    801054ef <alltraps>
...
8010621c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106221:	e9 c9 f2 ff ff       	jmp    801054ef <alltraps>
...
80106228:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010622d:	e9 bd f2 ff ff       	jmp    801054ef <alltraps>
...
80106234:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106239:	e9 b1 f2 ff ff       	jmp    801054ef <alltraps>
...
80106240:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106245:	e9 a5 f2 ff ff       	jmp    801054ef <alltraps>
...
8010624c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106251:	e9 99 f2 ff ff       	jmp    801054ef <alltraps>
...
80106258:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010625d:	e9 8d f2 ff ff       	jmp    801054ef <alltraps>
...
80106264:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106269:	e9 81 f2 ff ff       	jmp    801054ef <alltraps>
...
80106270:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106275:	e9 75 f2 ff ff       	jmp    801054ef <alltraps>
...
8010627c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106281:	e9 69 f2 ff ff       	jmp    801054ef <alltraps>
...
80106288:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010628d:	e9 5d f2 ff ff       	jmp    801054ef <alltraps>
...
80106294:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106299:	e9 51 f2 ff ff       	jmp    801054ef <alltraps>
...
801062a0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801062a5:	e9 45 f2 ff ff       	jmp    801054ef <alltraps>
...
801062ac:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801062b1:	e9 39 f2 ff ff       	jmp    801054ef <alltraps>
...
801062b8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801062bd:	e9 2d f2 ff ff       	jmp    801054ef <alltraps>
...
801062c4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062c9:	e9 21 f2 ff ff       	jmp    801054ef <alltraps>
...
801062d0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062d5:	e9 15 f2 ff ff       	jmp    801054ef <alltraps>
...
801062dc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062e1:	e9 09 f2 ff ff       	jmp    801054ef <alltraps>
...
801062e8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062ed:	e9 fd f1 ff ff       	jmp    801054ef <alltraps>
...
801062f4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801062f9:	e9 f1 f1 ff ff       	jmp    801054ef <alltraps>
...
80106300:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106305:	e9 e5 f1 ff ff       	jmp    801054ef <alltraps>
...
8010630c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106311:	e9 d9 f1 ff ff       	jmp    801054ef <alltraps>
...
80106318:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010631d:	e9 cd f1 ff ff       	jmp    801054ef <alltraps>
...
80106324:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106329:	e9 c1 f1 ff ff       	jmp    801054ef <alltraps>
...
80106330:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106335:	e9 b5 f1 ff ff       	jmp    801054ef <alltraps>
...
8010633c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106341:	e9 a9 f1 ff ff       	jmp    801054ef <alltraps>
...
80106348:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010634d:	e9 9d f1 ff ff       	jmp    801054ef <alltraps>
...
80106354:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106359:	e9 91 f1 ff ff       	jmp    801054ef <alltraps>
...
80106360:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106365:	e9 85 f1 ff ff       	jmp    801054ef <alltraps>
...
8010636c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106371:	e9 79 f1 ff ff       	jmp    801054ef <alltraps>
...
80106378:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010637d:	e9 6d f1 ff ff       	jmp    801054ef <alltraps>
...
80106384:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106389:	e9 61 f1 ff ff       	jmp    801054ef <alltraps>
...
80106390:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106395:	e9 55 f1 ff ff       	jmp    801054ef <alltraps>
...
8010639c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801063a1:	e9 49 f1 ff ff       	jmp    801054ef <alltraps>
...
801063a8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801063ad:	e9 3d f1 ff ff       	jmp    801054ef <alltraps>
...
801063b4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063b9:	e9 31 f1 ff ff       	jmp    801054ef <alltraps>
...
801063c0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063c5:	e9 25 f1 ff ff       	jmp    801054ef <alltraps>
...
801063cc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063d1:	e9 19 f1 ff ff       	jmp    801054ef <alltraps>
...
801063d8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063dd:	e9 0d f1 ff ff       	jmp    801054ef <alltraps>
...
801063e4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063e9:	e9 01 f1 ff ff       	jmp    801054ef <alltraps>
...
801063f0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063f5:	e9 f5 f0 ff ff       	jmp    801054ef <alltraps>
...
801063fc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106401:	e9 e9 f0 ff ff       	jmp    801054ef <alltraps>
...
80106454:	e8 47 c0 ff ff       	call   801024a0 <kalloc>
...
80106472:	e8 09 df ff ff       	call   80104380 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106511:	c3                   	ret    
      panic("remap");
80106512:	c7 04 24 ec 75 10 80 	movl   $0x801075ec,(%esp)
...
80106563:	e8 88 bd ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
801065c3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801065c6:	e8 b5 d0 ff ff       	call   80103680 <cpuid>
...
80106680:	a1 a4 54 11 80       	mov    0x801154a4,%eax
{
...
801066c4:	0f 84 c3 00 00 00    	je     8010678d <switchuvm+0xed>
  pushcli();
801066ca:	e8 01 db ff ff       	call   801041d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801066cf:	e8 2c cf ff ff       	call   80103600 <mycpu>
801066d4:	89 c3                	mov    %eax,%ebx
801066d6:	e8 25 cf ff ff       	call   80103600 <mycpu>
801066db:	89 c7                	mov    %eax,%edi
801066dd:	e8 1e cf ff ff       	call   80103600 <mycpu>
801066e2:	83 c7 08             	add    $0x8,%edi
801066e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801066e8:	e8 13 cf ff ff       	call   80103600 <mycpu>
...
8010672e:	e8 cd ce ff ff       	call   80103600 <mycpu>
80106733:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010673a:	e8 c1 ce ff ff       	call   80103600 <mycpu>
...
80106756:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106759:	e8 a2 ce ff ff       	call   80103600 <mycpu>
...
80106781:	c7 04 24 f2 75 10 80 	movl   $0x801075f2,(%esp)
80106788:	e8 d3 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010678d:	c7 04 24 1d 76 10 80 	movl   $0x8010761d,(%esp)
80106794:	e8 c7 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106799:	c7 04 24 08 76 10 80 	movl   $0x80107608,(%esp)
...
801067cb:	77 54                	ja     80106821 <inituvm+0x71>
  mem = kalloc();
801067cd:	e8 ce bc ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801067e7:	e8 94 db ff ff       	call   80104380 <memset>
...
8010681b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010681c:	e9 ff db ff ff       	jmp    80104420 <memmove>
    panic("inituvm: more than a page");
80106821:	c7 04 24 31 76 10 80 	movl   $0x80107631,(%esp)
...
801068ad:	e8 ae b0 ff ff       	call   80101960 <readi>
...
801068d2:	c7 04 24 4b 76 10 80 	movl   $0x8010764b,(%esp)
801068d9:	e8 82 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068de:	c7 04 24 ec 76 10 80 	movl   $0x801076ec,(%esp)
...
80106933:	e8 48 da ff ff       	call   80104380 <memset>
...
80106964:	76 2a                	jbe    80106990 <allocuvm+0xa0>
    mem = kalloc();
80106966:	e8 35 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106971:	c7 04 24 69 76 10 80 	movl   $0x80107669,(%esp)
...
801069a0:	c7 04 24 81 76 10 80 	movl   $0x80107681,(%esp)
...
801069c1:	e8 2a b9 ff ff       	call   801022f0 <kfree>
      return 0;
...
80106a4d:	e8 9e b8 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106a62:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106a63:	e9 88 b8 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106a68:	c7 04 24 9d 76 10 80 	movl   $0x8010769d,(%esp)
...
80106a88:	e8 13 ba ff ff       	call   801024a0 <kalloc>
...
80106b1b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106b4b:	c3                   	ret    
    panic("clearpteu");
80106b4c:	c7 04 24 ae 76 10 80 	movl   $0x801076ae,(%esp)
...
80106b9d:	e8 7e d8 ff ff       	call   80104420 <memmove>
...
80106c2b:	e8 c0 b6 ff ff       	call   801022f0 <kfree>
      goto bad;
...
80106c34:	eb d8                	jmp    80106c0e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106c36:	c7 04 24 d2 76 10 80 	movl   $0x801076d2,(%esp)
80106c3d:	e8 1e 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c42:	c7 04 24 b8 76 10 80 	movl   $0x801076b8,(%esp)
...
80106ccc:	e8 4f d7 ff ff       	call   80104420 <memmove>
    len -= n;
    buf += n;
